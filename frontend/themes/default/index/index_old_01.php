...
//$this->registerJsFile('js/f_ban.js');
...
<div class="soubg">
    <div class="sou">
        ...
        <!--End 所在收货地区 End-->
        <span class="fr">
        	<span class="fl"><?= Html::a('你好，请登录', ['index/login']) ?>&nbsp; <a href="<?= \yii\helpers\Url::to('index/regist')?>" style="color:#ff4e00;">免费注册</a>&nbsp;|&nbsp;<a href="<?= \yii\helpers\Url::to('order/index')?>">我的订单</a>&nbsp;|</span>
        	<span class="ss">
            	<div class="ss_list">
                    <a href="#">收藏夹</a>
